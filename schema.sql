...
('payment', '💳', '{"fr": "Quels sont les modes de paiement acceptés ?", "ar": "ما هي طرق الدفع المتاحة في المتجر؟", "en": "What payment methods do you accept?"}'::jsonb, '{"fr": "Nous acceptons BariDi Mob, CCP, Wise (EUR), USDT (Crypto) et Flexy (+19%). Les taux actuels sont affichés dans le panier.", "ar": "نوفر دفع عبر بريدي موب (BariDi Mob)، التحويل البريدي (CCP)، Wise، USDT، وبطاقات فليكسي Flexy (+19%). تظهر الأسعار الحالية في السلة.", "en": "We accept BariDi Mob, CCP, Wise (EUR), USDT Crypto, and Flexy mobile recharge (+19%). Current rates are shown in the cart."}'::jsonb, 4),
