(function () {
  ...
  function injectStyles() {
    ...
    style.textContent =
      ...
      "[data-notification-entry]{position:relative;overflow:visible!important}[data-notification-trigger]{position:relative;overflow:visible!important;isolation:isolate}[data-notification-trigger]:active{transform:none!important}[data-notification-badge]{position:absolute;top:-6px;right:-7px;min-width:18px;height:18px;padding:0 4px;display:inline-flex;align-items:center;justify-content:center;border:2px solid #080808;border-radius:999px;background:#39ff14;color:#050505;font-size:9px;font-weight:950;line-height:1;box-sizing:border-box;white-space:nowrap;pointer-events:none;z-index:4;box-shadow:0 0 13px rgba(57,255,20,.4)}[dir=rtl] [data-notification-badge]{right:auto;left:-7px}" +
