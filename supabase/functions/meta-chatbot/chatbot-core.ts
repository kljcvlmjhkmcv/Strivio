...
export const CHATGPT_MONTHLY_META_ADSET_ID_CURRENT = "120255278422410273";
export const CHATGPT_MONTHLY_META_AD_ID_CURRENT = "120255278422420273";
...
const CHATGPT_MONTHLY_META_IDS = new Set([
  ...
  CHATGPT_MONTHLY_META_ADSET_ID_CURRENT,
  CHATGPT_MONTHLY_META_AD_ID_CURRENT,
]);
